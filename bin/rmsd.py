...
# Save
Saver.Array(array=rmsd_timeseries, out_name=os.path.join('rmsd_' + out_dir, 'rmsd_' + out_dir  + '.dat')).save()
...
fig1.savefig(os.path.join('rmsd_'+out_dir,'rmsd_'+out_dir+'.png'), pad_inches=0.03, bbox_inches='tight', dpi=200)
fig1.savefig(os.path.join('rmsd_'+out_dir,'rmsd_'+out_dir+'.tiff'), pad_inches=0.03, bbox_inches='tight', dpi=600)
fig1.savefig(os.path.join('rmsd_'+out_dir,'rmsd_'+out_dir+'.pdf'), bbox_inches='tight')
