...
inputs.add_argument('-tm', action='store', dest='time', help='Time interval(ps)', type=str, default='0.1ns')
...
# Find Helper scripts
cluster_script = '/home/wud18/python/Dist_Na_220sLoop.py'
...
python_NaBinding_cmd = (
    ...
    ',tm=' + UserInput.time +
    ',o=' + UserInput.out_dir +
    ' /home/wud18/bash/NaDistSubmit_AH.slurm'
    )
