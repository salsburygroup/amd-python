...
import sys
from write_nmd_file import writeNMD
from scipy.spatial.distance import euclidean
from Analysis import AtomSelection, DimensionReduction, Featurizer, TrajectoryReader, Saver
...
print(components)
writeNMD(UserInput.out_name + '.nmd', components, UserInput.sel)
