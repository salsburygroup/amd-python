...
# interval1
interval1="sed -n '" + str(interval*0+1) + "," + str(interval) + "p' timeseries.txt > timeseries1.txt"
os.system(interval1)
...
# interval2
interval2="sed -n '" + str(interval*1+1) + "," + str(interval*2) + "p' timeseries.txt > timeseries2.txt"
os.system(interval2)
...
# interval3
interval3="sed -n '" + str(interval*2+1) + "," + str(interval*3) + "p' timeseries.txt > timeseries3.txt"
os.system(interval3)
...
# interval4
interval4="sed -n '" + str(interval*3+1) + "," + str(interval*4) + "p' timeseries.txt > timeseries4.txt"
os.system(interval4)
